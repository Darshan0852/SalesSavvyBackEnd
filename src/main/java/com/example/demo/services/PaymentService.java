...
public class PaymentService {
    ...
    public PaymentService(OrderRespository orderRepository, OrderItemRepository orderItemRepository, CartRepository cartRepository) {
    ...
    @Transactional
    public String createOrder(int user, BigDecimal totalAmount, List<OrderItem> cartItems) throws RazorpayException {
