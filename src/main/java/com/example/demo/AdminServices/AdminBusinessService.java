...
public class AdminBusinessService {
	...
	public AdminBusinessService(OrderRespository orderRepository, OrderItemRepository orderItemRepository, ProductRepository productRepository) {
	...
	public Map<String, Object> calculateOverallBusiness() {
	    ...
	    List<Order> successfulOrders = orderRepository.findAllByStatus(Status.SUCCESS);
